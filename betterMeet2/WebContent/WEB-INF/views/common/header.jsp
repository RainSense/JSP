...
<body>
	...
	<div class="header navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand cute_font" href="<%=request.getContextPath()%>">Better Meet</a>
		...
		<span class="navbar-toggler-icon"></span>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
				  <li class="nav-item">
				    <a class="nav-link cute_font"  href="<%=request.getContextPath()%>/notice/list.do">공지사항</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link cute_font" href="<%=request.getContextPath()%>/noticeEx/list.do">모임 상세보기</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link cute_font" href="#">추천 모임</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link cute_font" href="<%=request.getContextPath()%>/board/boardView.do">게시판</a>
				  </li>
	...
	<div class="modal fade" id="modal-container-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">						<!-- request.getContextPath() : 요청 주소 중 최상위 주소 (/wsp)를 얻어옴. -->
