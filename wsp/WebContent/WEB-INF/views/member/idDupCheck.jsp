	...
	<script type="text/javascript">
		...
		function idValue(){
			...
			if( id  == "null"){
				...
				// opener : 팝업창을 열은 부모창
				// document : 문서
				// signUpForm : 부모창 회원가입 form태그의 name 속성
				// id : 부모창 form 태그 내부에 name속성이 id인 태그 선택
		...
		if (result==0){
			...
			// 	부모창에 hidden 타입 요소의 value 값을 true로 변경
		...
		$("#idChekcForm").submit(function(){
			var regExp = /^[a-zA-Z][a-zA-Z\d]{5,11}$/;
